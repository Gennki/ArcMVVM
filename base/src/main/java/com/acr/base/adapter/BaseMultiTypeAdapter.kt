...
abstract class BaseMultiTypeAdapter<T> : RecyclerView.Adapter<BaseMultiTypeAdapter.MultiTypeViewHolder>() {
    ...
    protected inline fun <reified DB : ViewDataBinding> loadLayout(DBClass: Class<DB>, parent: ViewGroup): DB {
        val inflateMethod = DBClass.getDeclaredMethod("inflate", LayoutInflater::class.java, ViewGroup::class.java, Boolean::class.java)
        return inflateMethod.invoke(null, LayoutInflater.from(parent.context), parent, false) as DB
    }
